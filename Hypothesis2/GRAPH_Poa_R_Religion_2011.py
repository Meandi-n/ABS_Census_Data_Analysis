...
#FUNCTION AND DESCRIPTION
	...
	the population examined here is the year 2011. 
////////////////////////////////////////////////////////////////////
#AUTHOR: RYAN MAY
#STUDENT ID: 19477774
...
x.DATA_DIR = "../Processing_Data/2011_Religious_Data.csv"
...
def RELIGION_COUNT(x):
	...
	ax1.axis('equal')
	plt.tight_layout()
	plt.savefig('Graphs/PIE_RELIGION_PERTH_2011.png')
	plt.show()
...
MATPLOTLIBSETUP(plt, "Religion as a function of postalcode", \
				"Postalcode", "Population", 'Graphs/RELIGION_R_POA_2011.png')
...
MATPLOTLIBSETUP(plt, "Atheism as a function of postalcode", \
				"Postalcode", "Population", 'Graphs/ATHEISM_R_POA_2011.png')
